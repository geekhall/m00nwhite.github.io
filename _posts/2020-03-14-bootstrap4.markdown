...
* flex-direction：可以取四个值：
  ...
  - row: 主轴水平方向，从左至右排列
    ...
    ![](https://yinyang.space/img/20210314_flex-row.png)

  - row-reverse：主轴水平方向，从右至左排列

    ![](https://yinyang.space/img/20210314-flex-row-reverse.png)

  - column：主轴竖直方向，从上至下排列

    ![](https://yinyang.space/img/20210314-flex-direction-column.png)

  - column-reverse：主轴竖直方向，从下至上排列

    ![](https://yinyang.space/img/20210314-flex-column-reverse.png)

* flex-wrap/flex-nowrap ： 当容器显示不下时换行/不换行

  - flex-wrap:

    ![](https://yinyang.space/img/20210314-wrap.png)

  

  - flex-nowrap:![](https://yinyang.space/img/20210314-nowrap.png)

  

* flex-basis：定义了item元素的空间大小。

  ![](https://yinyang.space/img/20210314-flex-basis.png)
...
* align-items：属性可以使元素在交叉轴方向对齐，应用于父容器。
  ...
  - streth： 拉伸到最大容器对齐
    ...
    ![](https://yinyang.space/img/20210314-flex-streth.png)

  - flex-start：![](https://yinyang.space/img/20210314-flex-align-start.png)

  - flex-end

    ![](https://yinyang.space/img/20210314-flex-item-end.png)

  - center

    ![](https://yinyang.space/img/20210314-flex-center.png)
...
* Justify-content：使元素在主轴方向对齐，主轴方向是通过 `flex-direction` 设置的方向，初始值为flex-start，
  ...
  - flex-start：
    ...
    ![](https://yinyang.space/img/20210314-flex-justify-start.png)

  - flex-end：

    ![](https://yinyang.space/img/20210314-flex-justify-end.png)

  - center：

    ![](https://yinyang.space/img/20210314-flex-justify-center.png)

  - space-evenly:

    ![](https://yinyang.space/img/20210314-flex-space-evenly.png)

  - space-around：

    ![](https://yinyang.space/img/20210314-flex-space-around.png)

  - space-between：

    ![](https://yinyang.space/img/20210314-flex-space-between.png)
